/*
 * resource set indices for pphlprsc
 *
...
#endif
#ifndef __ALCYON__
#define RSC_NAME "pphlprsc"
#endif
#ifdef RSC_ID
#undef RSC_ID
#endif
#ifdef pphlprsc
#define RSC_ID pphlprsc
#else
#define RSC_ID 0
#endif
...
#  endif
#endif
extern _WORD pphlprsc_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD pphlprsc_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD pphlprsc_rsc_free(void);
#endif
